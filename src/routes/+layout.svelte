    ...
    <header class="bg-background sticky top-0 flex h-16 items-center gap-4 border-b px-4 md:px-6">
      ...
      >
        <a href="/" class="flex items-center gap-2 text-lg font-semibold md:text-base">
          ...
          <span class="sr-only">SG</span>
        </a>
        <a href="/" class="text-muted-foreground hover:text-foreground transition-colors">
          Home
        </a>
        <a href="/svelte-basics" class="text-muted-foreground hover:text-foreground transition-colors">
          Svelte Basics
        </a>
        <a href="/advanced-svelte" class="text-muted-foreground hover:text-foreground transition-colors">
          Advanced Svelte
        </a>
        <a href="/sveltekit-basics" class="text-muted-foreground hover:text-foreground transition-colors">
          SvelteKit Basics
        </a>
        <a href="/advanced-sveltekit" class="text-foreground hover:text-foreground transition-colors">
         Advanced SvelteKit
        </a>
        <a href="/extra-info" class="text-foreground hover:text-foreground transition-colors">
          Extra Info
        </a>
      </nav>
      <Sheet.Root>
