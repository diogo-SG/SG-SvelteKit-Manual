...
<CodeWrapper headerText={HEADER.EVENTS} code={CODE.CLICK} />
...
<CodeWrapper headerText={HEADER.EVENTS} code={CODE.INLINE_HANDLERS} />
...
<CodeWrapper headerText={HEADER.EVENTS} code={CODE.MODIFIERS} />
...
<CodeWrapper headerText={HEADER.EVENTS} code={CODE.COMPONENTS_PARENT} />

<p>On our <span class="font-bold">child</span> component:</p>

<CodeWrapper headerText={HEADER.EVENTS} code={CODE.COMPONENTS_CHILD} />
...
<p>On our <span class="font-bold">parent</span> component:</p>
<CodeWrapper headerText={HEADER.EVENTS} code={CODE.FORWARDING_PARENT} />

<p>On our <span class="font-bold">child</span> component:</p>
<CodeWrapper headerText={HEADER.EVENTS} code={CODE.FORWARDING_CHILD} />

<p>On our <span class="font-bold">grandchild</span> component:</p>
<CodeWrapper headerText={HEADER.EVENTS} code={CODE.FORWARDING_GRANDCHILD} />
...
<p>On our <span class="font-bold">parent</span> component:</p>
<CodeWrapper headerText={HEADER.EVENTS} code={CODE.DOM_PARENT} />

<p>On our <span class="font-bold">child</span> component:</p>
<CodeWrapper headerText={HEADER.EVENTS} code={CODE.DOM_CHILD} />
